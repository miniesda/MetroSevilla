  ...
  return (
    <a-scene mindar-image="imageTargetSrc: https://raw.githubusercontent.com/miniesda/MetroSevilla/main/my-app/public/targets/targets.mind; maxTrack: 8" color-space="sRGB" vr-mode-ui="enabled: false" device-orientation-permission-ui="enabled: false">
          ...
          <a-entity mindar-image-target="targetIndex: 0">
            <MapStation  id={1} name="Ciudad Expo" position="-0.4 -0.23 0" services={["bici", "patines", "bus", "parking"]}/>
    
            <MapStation  id={2} name="Cavaleri" position="-0.3 -0.05 0" services={["bici", "patines"]}/>
    
            <MapStation  id={3} name="San Juan Alto" position="0.05 0.3 0" services={["bici", "patines", "bus", "parking"]}/>
          </a-entity>
          <a-entity mindar-image-target="targetIndex: 1">
            <MapStation  id={4} name="San Juan Bajo" position="-0.2 0 0" services={["bici", "patines", "bus", "cargador", "parking"]}/>
          ...
          <a-entity mindar-image-target="targetIndex: 3">
            ...
            <MapStation  id={10} name="San Bernardo" position="0.1 -0.05 0" services={["bici", "bus", "tranvia", "cercanias"]}/>
          </a-entity>
          ...
          <a-entity mindar-image-target="targetIndex: 6">
            <MapStation  id={18} name="Pablo Olavide" position="0.1 0.1 0" services={["bici", "patines", "bus"]} cambioTramo={true}/>

            <MapStation  id={19} name="Condequinto" position="0.3 -0.2 0" services={["bici", "patines", "cargador", "parking"]}/>
          </a-entity>
          <a-entity mindar-image-target="targetIndex: 7">
            <MapStation  id={20} name="Montequinto" position="0.4 0.25 0" services={["patines"]}/>

            <MapStation  id={21} name="Europa" position="0.35 0.05 0" services={["patines"]}/>

            <MapStation  id={22} name="Olivar de Quintos" position="0.25 -0.3 0" services={["bus", "parking"]}/>
          </a-entity>
